...
export const SignUpPage = () => {
  ...
  const onSubmit = async (data) => {
    if (!data) {
      return showToast("Invalid form input.", "error", 2000);
    }
    ...
    try {
      ...
      if (!res?.success) {
        showToast(res?.message || "Sign up failed.", "error", 2000);
        return;
      }
      ...
      showToast("Sign up failed. Please try again.", "error", 2000);
    }
  };
    ...
    <section className="flex flex-col items-center justify-center">
      <div className="w-full max-w-md">
        <form
          ...
          className="bg-white shadow rounded-md px-8 pt-6 pb-8 md:bg-transparent md:shadow-none dark-theme"
        >
          <div className="">
            ...
            <p className="text-sm text-gray-500 mb-6 dark:text-gray-300">
              Join us and start managing your expenses today! Please fill out
