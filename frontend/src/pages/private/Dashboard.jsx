...
export const Dashboard = () => {
  ...
  const { data: allExpenses, isLoading: isLoadingExpenses } =
    useGetTodayExpenses({ userId: user?.accountId, forToday: true });
  ...
  return (
    <section className="">
      ...
      <div className="flex items-center justify-between gap-2 mb-4">
        ...
        <button
          onClick={toggleModal}
          className="flex-1 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold py-2 px-2 rounded"
        >
          Add Expense
        </button>
      </div>
